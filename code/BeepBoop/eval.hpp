...
class Evaluator
{
 ...
 private:
  ...
  static constexpr int eg_pawn_table[64] = {0,   0,   0,   0,   0,   0,   0,   0,    //
  ...
  static constexpr int mg_knight_table[64] = {-167, -89, -34, -49, 61,  -97, -15, -107,  //
  ...
  static constexpr int eg_knight_table[64] = {-58, -38, -13, -28, -31, -27, -63, -99,  //
  ...
  static constexpr int mg_bishop_table[64] = {-29, 4,  -82, -37, -25, -42, 7,   -8,   //
  ...
  static constexpr int eg_bishop_table[64] = {-14, -21, -11, -8,  -7, -9,  -17, -24,  //
                                              -8,  -4,  7,   -12, -3, -13, -4,  -14,  //
                                              2,   -8,  0,   -1,  -2, 6,   0,   4,    //
                                              -3,  9,   12,  9,   14, 10,  3,   2,    //
                                              -6,  3,   13,  19,  7,  10,  -3,  -9,   //
  ...
  static constexpr int mg_rook_table[64] = {32,  42,  32,  51,  63, 9,  31,  43,   //
  ...
  static constexpr int eg_rook_table[64] = {13, 10, 18, 15, 12, 12,  8,   5,    //
                                            11, 13, 13, 11, -3, 3,   8,   3,    //
                                            7,  7,  7,  5,  4,  -3,  -5,  -3,   //
                                            4,  3,  13, 1,  2,  1,   -1,  2,    //
                                            3,  5,  8,  4,  -5, -6,  -8,  -11,  //
  ...
  static constexpr int mg_queen_table[64] = {-28, 0,   29,  12,  59,  44,  43,  45,  //
  ...
  static constexpr int eg_queen_table[64] = {-9,  22,  22,  27,  27,  19,  10,  20,   //
  ...
  static constexpr int mg_king_table[64] = {-65, 23,  16,  -15, -56, -34, 2,   13,   //
                                            29,  -1,  -20, -7,  -8,  -4,  -38, -29,  //
  ...
  static constexpr int eg_king_table[64] = {-74, -35, -18, -18, -11, 15,  4,   -17,  //
